...
class TransaksiBloc {
  ...
  Stream<List<LogPemesananModel>> get countItemTransaksi => _getItemTransaksi.stream;
  ...
  getItemTransaksi(String kd_pemesanan, String id_pelanggan) async {
    List<LogPemesananModel> lg = await _repo.getItemTransaksi(kd_pemesanan, id_pelanggan);
