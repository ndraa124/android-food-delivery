            ...
            children: [
              Expanded(
                child: FlatButton(
                  ...
                  color: !isValidNama || !isValidNoTelp || !isValidEmail || !isValidPassword ? Colors.lightBlue[800].withOpacity(0.5) : Colors.lightBlue[800],
                  onPressed: () {
                    if (isValidNama && isValidNoTelp && isValidEmail && isValidPassword) {
                      _getValidateEmail();
                    } else {
                      validateNama(state);
                      validateNoTelp(state);
