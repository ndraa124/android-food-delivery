...
class _LoginState extends State<Login> {
            ...
            children: [
              Expanded(
                child: FlatButton(
                  ...
                  color: !isValidEmail || !isValidPassword ? Colors.lightBlue[800].withOpacity(0.5) : Colors.lightBlue[800],
                  onPressed: () {
  ...
  _getValidateEmail() async {
    ...
    if (status) {
      ...
      ShowToast().showToastError('Email anda belum terdaftar! Silahkan daftar terlebih dahulu.');
    }
  }
  ...
  _login() async {
    ...
    if (status) {
      ...
      ShowToast().showToastError('Email atau password salah! Coba lagi.');
    }
  }
}
